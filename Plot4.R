# 
# plot4.R -- generate 4 plots for days from 2/1/2001 to 2/2/2007
#
...
ylabel <- "Global Active Power"  # y axis label
...
ylabel <- "Voltage"
xlabel <- "datetime"
plot(HPC_subset$Voltage, typ='l', ylab=ylabel, xlab=xlabel, xaxt="n")
axis(1, at=x_label_locs, labels=x_labels)
...
xlabel <- "datetime"
plot(HPC_subset$Global_reactive_power, typ='l', ylab=ylabel, xlab=xlabel, xaxt="n")
axis(1, at=x_label_locs, labels=x_labels)
